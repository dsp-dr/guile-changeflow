...
*Troubleshooting*: See [[file:docs/CLAUDE-AI-MCP-INTEGRATION.org][Claude.ai Integration Guide]] and [[file:docs/MCP-SEQUENCE-DIAGRAMS.org][Sequence Diagrams]]
...
Contributions welcome via pull requests. See the [[https://github.com/dsp-dr/guile-changeflow/issues][issue tracker]] for open work.
...
- MCP Server: [[https://mcp.changeflow.us][mcp.changeflow.us]]